...
int main(int argc , char *argv[]){
	string pwd = "amd2:/home/user_home/xiaomingxu/dataProcessing/simulate_longSequences";
	...
	args.push_back("error_rate*1000(integer)");
	...
	descriptions.push_back("the mutation rate to generate sequence from each clusters");
	descriptions.push_back("the number of seed sequence (number of clusters) to generate");
	descriptions.push_back("the number sequence in a cluster generate from each seed sequence");
	descriptions.push_back("the length for each sequence");
